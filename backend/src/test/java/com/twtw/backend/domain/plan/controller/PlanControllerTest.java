...
class PlanControllerTest extends RestDocsTest {
    ...
    void searchPlanDestination() throws Exception {
        //given
        final PlanDestinationResponse expected = new PlanDestinationResponse(List.of(
                new PlaceDetails(
                        "이디야커피 안성죽산점",
                        "435",
        ...
        final ResultActions perform = mockMvc.perform(
                get("/plans/search/destination")
                        ...
                        .header("Authorization", "Bearer wefa3fsdczf32.gaoiuergf92.gb5hsa2jgh"));
        ...
        //docs
        perform.andDo(print())
                .andDo(document("get search plan destination", getDocumentRequest(), getDocumentResponse()));
    }
}
